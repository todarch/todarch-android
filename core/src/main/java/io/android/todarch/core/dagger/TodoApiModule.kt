...
import io.android.todarch.core.data.api.AuthenticationInterceptor
...
class TodoApiModule {
    ...
    @Singleton
    @Provides
    internal fun provideServices(@Named(NAMED_TODARCH) retrofit: Retrofit): TodarchService =
        retrofit.create(TodarchService::class.java)

    @Singleton
    @Provides
    @Named(NAMED_TODARCH)
    internal fun provideRetrofit(@Named(NAMED_TODARCH) okHttpClient: OkHttpClient): Retrofit {
    ...
    internal fun provideOkHttpClient(
        ...
        @Named(NAMED_TODARCH) interceptors: Array<Interceptor>?,
    ...
    internal fun provideHttpInterceptors(
        service: UserService,
        session: Session
    ): Array<Interceptor>? = arrayOf(AuthenticationInterceptor(service, session))
